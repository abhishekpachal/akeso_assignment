...
import { getAssignedTasks } from "@/features/taskSlice";
...
export default function AssignedTasksPage() {
  ...
  const { assignedTasks, loading, error } = useSelector((state) => state.task);
  ...
  return (
    <div className="min-h-screen">
      <h1 className="text-2xl font-bold mt-10 mb-2">RECEIVED TASKS</h1>
      <hr className="mb-6" />
